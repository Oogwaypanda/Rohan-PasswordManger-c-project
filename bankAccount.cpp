...
class bankAccount {
    private:
        string bankName = "ROCBI";  // ROCBI101
        int bankCode;
...
void bankAccount::createAccount()   {
    ...
    balance = 500.0;
    ifstream file("Rohan-Code-Bank-Of-India.txt");
    if(file.is_open())  {

        file>>bankCode;
        file.close();
        ofstream output("Rohan-Code-Bank-Of-India.txt");
...
void bankAccount::accountDetails() {
    ...
    Magenta();
    cout<<"|------------------------------|"<<endl;
    cout<<"|  Rohan Code Bank Of India    |"<<endl;
    cout<<"|------------------------------|"<<endl;
    Blue();
...
int main() {
    ...
    do {
        cout<<" Welcome to Rohan Code Bank Of India" << endl;
        cout<<"--------------------------------------"<<endl;
